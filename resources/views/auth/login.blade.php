                                    ...
                                    <div class="card-body">
                                        <form method='post' action="{{route('login')}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputEmailAddress" name='email' type="email" placeholder="Masukkan email anda" />
                                            </div>
                                            <div class="form-group">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Antrian Online 2021</div>
                            <div>
